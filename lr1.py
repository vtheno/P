...
class AssociativeError(Exception):
    pass
...
class EQ(metaclass=Compare):
    pass


class LE(metaclass=Compare):
    pass


class GE(metaclass=Compare):
    pass
...
class Left(metaclass=Associative):
    pass


class Right(metaclass=Associative):
    pass
                                ...
                                if cmp_flag == EQ:
                                    ...
                                    if X_assoc != lookahead_assoc:
                                        raise AssociativeError(
                                            "left- and right-associative operators of equal precedence"
                                        )
                                    if X == lookahead:
